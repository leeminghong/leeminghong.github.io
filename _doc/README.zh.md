...
### [我的博客在这里 &rarr;](http://leeminghong.github.io)
...
```
# Site settings
title:  Minghong Blog       # 博客网站标题
SEOTitle: Minghong Blog			# 在后面会详细谈到
description: "Cool Blog"    # 描述
...
sidebar-avatar: /img/photo.jpg     #你的大头贴，请使用绝对地址.
```
...
# Google Analytics
ga_track_id: 'UA-xxxxxxxx-1'            # 你用Google账号去注册一个就会给你一个这样的id
ga_domain: xxx		# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
1. 这个模板是从这里[Huxpro](https://github.com/Huxpro/huxpro.github.io.git)  fork 的，感谢这个作者。（一些模板说明文档写的非常好，部分保留，文章创作内容并没有任何相同之处）
